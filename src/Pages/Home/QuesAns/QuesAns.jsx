          ...
          <section className="grid grid-cols-1 lg:grid-cols-[2fr,_3fr] items-center gap-16 md:gap-8 lg:gap-12 xl:gap-20">
            ...
            <div>
              ...
              >
                ...
                <div className="collapse-content">
                  <p className={darkTheme ? 'text-gray-200' : ''}>
                    To register for a marathon, browse the list of upcoming
                    events on our website, select your desired marathon, and
                    click the Register button. Complete the registration form
                    and payment process to confirm your participation.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="collapse-content">
                  <p className={darkTheme ? 'text-gray-200' : ''}>
                    Yes, you can update your marathon details by logging into
                    your account, navigating to your dashboard, and selecting
                    the Edit Registration option for the respective marathon.
                    Please note that changes may not be allowed after the
              ...
              >
                ...
                >
                  <p>
                    What is the refund policy if I cannot attend a marathon
                    after registering?
                  </p>
                </div>
                <div className="collapse-content">
                  <p className={darkTheme ? 'text-gray-200' : ''}>
                    Refund policies vary by event and are determined by the
                    event organizer. Please check the event-specific details on
                    the marathons page. Some events may offer partial refunds if
