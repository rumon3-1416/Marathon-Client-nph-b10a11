        ...
        >
          <div className="grid md:grid-cols-2 items-center">
            ...
            <div className="py-6 ps-4 pe-8">
              <img
                className="max-h-[25rem] aspect-square object-cover mx-auto rounded-md hidden md:block"
            ...
            <div className="p-8">
              ...
              <div className="mt-12 flex items-start gap-4">
                ...
                <div>
                  ...
                  >
                    Be a member and Elevate Your Runs with the Ultimate
                    Community.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-10 flex items-start gap-4">
                ...
                <div>
                  ...
                  >
                    Elevate Your Runs with the Ultimate Community and be a
                    member.
                  </p>
                </div>
              </div>
